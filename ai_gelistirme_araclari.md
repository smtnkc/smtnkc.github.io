...
description: AI skill, plugin, MCP sunucusu ve destekleyici geliştirme araçlarını rol ve genel kullanım zamanlarıyla bir araya getiren pratik katalog.
lang: tr
...
| Web bileşenleri | [shadcn/ui](https://ui.shadcn.com/) | Yeniden kullanılabilir ve kod sahipliği projede kalan React arayüz bileşenleri sağlar. | Özelleştirilebilir web arayüzleri oluştururken |
