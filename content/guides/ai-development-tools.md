...
description: A practical directory of AI skills, plugins, MCP servers, and supporting development tools.
lang: en
...
A practical directory of AI skills, plugins, MCP servers, and supporting development tools.
...
| Code-driven video | [HyperFrames](https://github.com/heygen-com/hyperframes) | Allows AI agents and developers to generate deterministic MP4 videos and motion graphics using HTML, CSS, and JS. | When creating programmatic videos, dynamic motion graphics, or agent-driven video workflows |
...
| UI component access | [shadcn/ui MCP](https://ui.shadcn.com/docs/registry/mcp) | Enables agents to search, browse, and install shadcn registry components, blocks, and templates directly into projects. | When installing or exploring shadcn components and blocks directly through AI agents |
| Web UI guidance | [shadcn/ui Skills](https://ui.shadcn.com/docs/skills) | Provides coding agents with shadcn/ui component patterns, CLI commands, and project configuration guidance. | When building web interfaces with shadcn/ui or managing component architecture |
